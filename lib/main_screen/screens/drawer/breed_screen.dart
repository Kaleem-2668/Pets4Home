...
class _BreedScreenState extends State<BreedScreen> {
  ...
  Future<void> _initializeData() async {
    ...
    final breedList = await articleViewModel.fetchBreedCategoryData();
    setState(() {
  ...
  Widget _buildNoDataUI() {
    return const Center(
      child: Text(
        'No breed category data available',
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          BreedCategoryModel selectedBreed =
                              breedCategoryList[index];
                          print(
                              'Breed Title****************************************: ${selectedBreed.breedTitle}');
                          print(
                              'Category Title********************************************: ${selectedBreed.categoryTitle}');
                          return Card(
                            elevation: 5,
                            ...
                            child: Column(
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: selectedBreed.breedImages !=
                                                null &&
                                            selectedBreed
                                                .breedImages!.isNotEmpty
